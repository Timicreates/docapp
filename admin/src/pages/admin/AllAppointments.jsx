    ...
    <div className="w-full max-w-6xl m-5">
      ...
      <div className="bg-white border border-gray-300 rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll  ">
        ...
        {appointments.map((item, index) => (
          <div
            key={index}
            className=" flex flex-wrap justify-between  max-sm:gap-2   sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 px-6 py-3 border-b border-gray-300 hover:bg-gray-50"
          >
            ...
            <p>
              {currency}
              {item.amount} {""}
              {item.payment ? " Paid" : "Not yet paid"}
            </p>
            {item.cancelled ? (
